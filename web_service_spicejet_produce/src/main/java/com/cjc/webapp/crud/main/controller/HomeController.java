...
public class HomeController 
{
	...
	@RequestMapping(value="/add_spicejet_flights_data",method=RequestMethod.POST)
	public String addflightsdata(@RequestBody Spicejet sj)
	{
		hs.saveflights(sj);
		return "SPICEJET FLIGHT ADDED........";
	}
	
	@RequestMapping(value="/getallflightsofspicejet",method=RequestMethod.GET)
	public Iterable<Spicejet> getaaflights()
	{
